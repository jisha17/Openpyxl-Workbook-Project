...
1. Create- Creates a workbook with three sheets named in it.
2.Writting- Used the created sheet to insert all datas in side the cell by formaating all entered cell.
